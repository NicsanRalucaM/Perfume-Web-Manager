function iterate(item, index) {
    document.getElementById("box_cont").innerHTML += ` <div class="box" name="box_item" id="box_det" >
        ...
        <a href="${"http://localhost:63342/Perfume-Web-Manager/PerMvar1/product.html?id=" + item.id}" id="redict" class="fas fa-eye"></a>
        ...
        <div class="btn"  name="add_to_cart" id="addCart" onclick="addProduct(${item.id})">Add to cart</div>
    </div>`;
